...
| Test Bench(배치 평가) 작업 (판단 케이스/policy 변경, run artifact 생성, 수치 인용) | [.claude/rules/experiments.md](.claude/rules/experiments.md), [.claude/rules/workflow.md](.claude/rules/workflow.md) |
