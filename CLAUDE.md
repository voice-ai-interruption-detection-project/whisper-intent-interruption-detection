...
- 하네스 원칙은 `docs/harness/concept.md`, 단계별 적용은 `docs/harness/plan.md`에 둔다.
- 분석 근거 (research archive)는 `docs/harness/research/` 아래에 있다 — `synthesis.md`, `external-references.md`, `devhub-blog.md`, `sprint4-code.md`.
- 작업 시 항상 켜둘 가드는 `.claude/rules/experiments.md`에 둔다 (PLAN의 "가벼운 규칙"과 run artifact 계약을 코드화).
