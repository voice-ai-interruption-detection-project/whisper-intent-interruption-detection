# Archived Product Planning

이 폴더는 2026-05-06~2026-05-07 초반 MVP 방향, 실행 계획, PRD, 용어 결정 원문을 보관하는 archive다.

현재 제품 방향, 범위, 용어, 평가 기준은 아래 active 자료를 우선한다.
...
- [MVP-방향성-초안.md](MVP-방향성-초안.md): 제품/실험 중심축을 잡기 위한 초기 방향성 문서.
- [MVP-계획서.md](MVP-계획서.md): 1주일 실행 단위로 풀어 쓴 초기 계획서.
- [MVP-PRD.md](MVP-PRD.md): 2차 회의 후 작성한 초기 PRD.
- [용어-결정-노트.md](용어-결정-노트.md): `AI Action Policy` 등 초기 용어 결정 원문.
