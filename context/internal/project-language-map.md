...
이 프로젝트는 전체 상담 앱을 한 번에 만들기보다, **음성 AI 상담에서 AI가 말하는 중 고객 신호가 들어온 한 순간**을 판단 케이스로 잘라 보고, AI가 어떤 다음 행동을 선택해야 자연스러운지 평가한다.
...
| `Workbench` | Playground와 Test Bench를 묶는 상위 실험 콘솔 후보 | 완성형 상담 앱 |
...
Text Replay는 음성 프로젝트를 포기하는 단계가 아니다. 오디오/STT 앞단을 잠시 고정하고, 뒤쪽 AI 행동 판단 구조를 먼저 검증하는 단계다.
