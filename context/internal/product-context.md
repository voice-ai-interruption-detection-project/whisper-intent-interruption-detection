...
현재 MVP는 전체 음성 상담 서비스를 완성하려는 시도가 아니다. AI가 말하는 중 들어온 고객 발화를 보고, AI가 다음 행동을 어떻게 고를지 검증하는 작은 실험이다.
...
| 사안 | 결정이 필요한 순간 |
| --- | --- |
| 대표 오디오 파일 범위 | Audio File Test를 대표 케이스 중심으로 둘지, 더 넓은 샘플 수로 확장할지 정할 때 |
